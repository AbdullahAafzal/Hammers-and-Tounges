...
const AdminCreateFinance = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsCreating(true);
    try {
      await adminService.createFinance({
      ...
      navigate(`${basePath}/users`, { state: { role: "finance" } });
    } catch (error) {
      const data = error?.response?.data;
      let message = "Failed to create finance user";
      if (data) {
        if (data.email) {
  ...
  return (
    <div className="create-manager-page">
      <header className="create-manager-header">
        <div>
          <h1 className="create-manager-title">Create Finance User</h1>
          <p className="create-manager-subtitle">
            Add a new finance user to the platform. All fields are required.
          </p>
        </div>
      </header>
          ...
          <form onSubmit={handleSubmit} className="create-manager-form">
            ...
            <div className="create-manager-form-group">
              ...
              <input
                ...
                disabled={isCreating}
                placeholder="e.g. Finance Team User"
              />
...
export default AdminCreateFinance;
