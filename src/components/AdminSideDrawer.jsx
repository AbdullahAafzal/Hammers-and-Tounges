...
const AdminSideDrawer = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { path: '/admin/goods-received-verification', label: 'Checklist & Goods Receive Verification', icon: 'M9 12l2 2 4-4m5 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    { path: '/admin/phantom-analytics', label: 'Phantom Analytics', icon: 'M9 10h.01M15 10h.01M12 2a8 8 0 0 0-8 8v4l-2 2h20l-2-2v-4a8 8 0 0 0-8-8z' },
